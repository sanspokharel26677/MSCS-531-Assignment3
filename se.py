...
# CPU configuration: Switch to DerivO3CPU for better TLB support
system.cpu = DerivO3CPU()

# Add TLB configuration for Instruction and Data TLB
#system.cpu.itb.size = 64  # Instruction TLB size
#system.cpu.dtb.size = 64  # Data TLB size
